...
class CustomerList(Resource):
    ...
    def get(self):
        try:
            ...
            # Récupération sécurisée de tous les clients
    ...
    def delete(self, customer_id):
        try:
            ...
            # Vérification si le client a des commandes en cours
            ...
            if pending_orders > 0:
                api.abort(400, f"Impossible de supprimer le client. Il a {pending_orders} commande(s) en attente.")
...
api.add_resource(CustomerList, '/admin/customers', '/admin/customers/<int:customer_id>')